...
<CaretSpecFile Version="1.0">
   ...
   <DataFile Structure="CortexLeft"
             DataFileType="SURFACE"
             Selected="true">
      S1200.L.pial_MSMAll.32k_fs_LR.surf.gii
   </DataFile>
   <DataFile Structure="CortexLeft"
             DataFileType="SURFACE"
             Selected="true">
   ...
   <DataFile Structure="CortexRight"
             DataFileType="SURFACE"
             Selected="true">
      S1200.R.pial_MSMAll.32k_fs_LR.surf.gii
   </DataFile>
   <DataFile Structure="CortexRight"
             DataFileType="SURFACE"
             Selected="true">
   ...
   <DataFile Structure="All"
             ...
             Selected="true">
      CortexSubcortex_ColeAnticevic_NetPartition_netassignments_v1pt02_LR.dlabel.nii
   </DataFile>
   <DataFile Structure="All"
             DataFileType="CONNECTIVITY_DENSE_LABEL"
             Selected="true">
      CortexSubcortex_ColeAnticevic_NetPartition_parcels_v1pt02_LR.dlabel.nii
   </DataFile>
   <DataFile Structure="All"
